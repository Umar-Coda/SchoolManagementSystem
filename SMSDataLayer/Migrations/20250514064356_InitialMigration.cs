    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AnnouncementUserId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AnnouncementId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnouncementUsers", x => x.AnnouncementUserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnouncementClasses", x => x.AnnouncementClassId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_TeacherClasses_TeacherClassId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Materials_TeacherClasses_TeacherClassId",
                        column: x => x.TeacherClassId,
                        principalTable: "TeacherClasses",
                        principalColumn: "TeacherClassId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Timetables_TeacherClasses_TeacherClassId",
                        column: x => x.TeacherClassId,
                        principalTable: "TeacherClasses",
                        principalColumn: "TeacherClassId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnnouncementClasses_AnnouncementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_TeacherClassId",
                table: "Assignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Materials_TeacherClassId",
                table: "Materials",
                column: "TeacherClassId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timetables_TeacherClassId",
                table: "Timetables",
                column: "TeacherClassId");
