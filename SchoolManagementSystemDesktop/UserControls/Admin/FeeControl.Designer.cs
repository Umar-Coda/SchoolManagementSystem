namespace SchoolManagementSystemDesktop.UserControls.Admin {
    partial class FeeControl {
        ...
        private void InitializeComponent() {
            ...
            ((System.ComponentModel.ISupportInitialize)feeDvg).BeginInit();
            SuspendLayout();
            // 
            // mainLayout
            // 
            ...
            mainLayout.Controls.Add(feeDvg, 0, 2);
            ...
            header.Size = new Size(371, 54);
            header.TabIndex = 0;
            header.Text = "Fee Management";
            ...
            // feeDvg
            // 
            feeDvg.BackgroundColor = Color.White;
            feeDvg.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            feeDvg.Columns.AddRange(new DataGridViewColumn[] { StudentName, CourseCode, ClassCode, AmountDue, AmountPaid, DueDate });
            feeDvg.Dock = DockStyle.Fill;
            feeDvg.Location = new Point(3, 167);
            feeDvg.Name = "feeDvg";
            feeDvg.RowHeadersWidth = 62;
            feeDvg.Size = new Size(1806, 654);
            feeDvg.TabIndex = 2;
            // 
            // StudentName
            // 
            ...
            AmountDue.DataPropertyName = "AmountDue";
            AmountDue.HeaderText = "Amount Due";
            AmountDue.MinimumWidth = 8;
            ...
            ((System.ComponentModel.ISupportInitialize)feeDvg).EndInit();
            ResumeLayout(false);
        }
